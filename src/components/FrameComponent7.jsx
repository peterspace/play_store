...
const FrameComponent7 = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-1 box-border gap-5 max-w-full text-left text-sm text-gray-100 font-roboto ${className}`}
    >
      ...
      <div className="w-[185px] flex flex-col items-start justify-start gap-5 text-lg">
      ...
      <div className="w-[185px] flex flex-col items-start justify-start gap-5">
      ...
      <div className="self-stretch bg-white flex flex-col items-start justify-start gap-5">
        <div className="self-stretch flex flex-row items-start justify-start flex-wrap content-start [row-gap:20px]">
          <SimilarGamesItem
            ...
            propDisplay="unset"
            propMinWidth="unset"
            similarGamesItemMinWidth="169px"
            similarFrameGap="20px"
            similarHeadingPadding="unset"
          ...
          <SimilarGamesItem
            propMarginLeft="unset"
            similarImage="/similar-image-21@2x.png"
            eASPORTSFC="MARIO"
            propHeight="unset"
            edkonGamesGmbH="Edkon Games GmbH"
            propDisplay="unset"
        ...
        <div className="self-stretch flex flex-row items-start justify-start flex-wrap content-start [row-gap:20px]">
          ...
          <SimilarGamesItem
            propMarginLeft="unset"
            similarImage="/similar-image-41@2x.png"
            eASPORTSFC="GUN RAVE"
            propHeight="unset"
            edkonGamesGmbH="Edkon Games GmbH"
            propDisplay="unset"
        ...
        <div className="self-stretch flex flex-row items-start justify-start flex-wrap content-start [row-gap:20px]">
          ...
          <SimilarGamesItem
            propMarginLeft="unset"
            similarImage="/similar-image-61@2x.png"
