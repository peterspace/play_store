...
const HeroGameContainer = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-5 box-border max-w-full text-left text-sm text-whitesmoke-200 font-roboto ${className}`}
    >
      <div className="flex-1 overflow-hidden flex flex-row items-start justify-start bg-[url('/hero-game@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full">
...
HeroGameContainer.propTypes = {
  className: PropTypes.string,
};

export default HeroGameContainer;
