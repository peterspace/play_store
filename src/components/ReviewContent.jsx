...
const ReviewContent = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-5 box-border gap-5 max-w-full text-left text-sm text-gray-100 font-roboto ${className}`}
    >
      ...
      <ReviewSummary propMinWidth="82px" propMinWidth1="144px" />
      ...
      <div className="self-stretch relative tracking-[0.2px] leading-[20px] text-dimgray">
