  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-start justify-start gap-5 max-w-full">
        ...
        <div className="self-stretch h-fit overflow-hidden shrink-0 flex flex-row items-start justify-start max-w-full text-base text-lightslategray">
          <div className="flex-1 relative tracking-[0.13px] leading-[25.6px] inline-block max-w-full">{description}</div>
        </div>
      </div>
    </section>
  );
