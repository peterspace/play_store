...
const ReviewerContainer = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start py-0 px-5 box-border max-w-full text-left text-base text-dimgray font-roboto ${className}`}
    >
      <div className="flex-1 flex flex-col items-start justify-start gap-5 max-w-full">
        ...
        <div className="w-[325px] relative text-sm tracking-[0.2px] leading-[20px] inline-block max-w-full">
