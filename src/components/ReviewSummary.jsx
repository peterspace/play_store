...
const ReviewSummary = ({ className = "", propMinWidth, propMinWidth1 }) => {
  ...
  const ratingVisualStyle = useMemo(() => {
    return {
  ...
  return (
    <div
      className={`w-[327px] flex flex-row items-start justify-start gap-[23px] max-w-full text-left text-37xl text-gray-100 font-roboto ${className}`}
    >
      <div
        className="w-[82px] flex flex-col items-start justify-start gap-2"
      ...
      <div
        className="flex-1 flex flex-col items-start justify-start pt-2 px-0 pb-0 text-xs text-dimgray"
        style={ratingVisualStyle}
      >
