...
const HeroGame2 = ({
  ...
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-10 box-border max-w-full text-left text-sm text-whitesmoke-200 font-roboto ${className}`}
    >
      <div
