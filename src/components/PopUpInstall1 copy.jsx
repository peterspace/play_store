const PopUpInstall1 = (props) => {
  ...
  return (
    <div
      className={`self-stretch rounded-lg bg-gainsboro-300 flex flex-col items-start justify-start p-5 box-border gap-5 max-w-full text-left text-xl text-black font-roboto`}
    >
      ...
      <div className="flex flex-row items-start justify-end py-0 pl-[145px] pr-0 gap-2.5 text-center text-3xs">
        {/* <div className="shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded bg-white flex flex-row items-start justify-start py-0 px-2.5">
          <div className="relative tracking-[0.25px] leading-[20px] inline-block min-w-[32px]">
            Cancel
          </div>
        </div> */}
        {/* <div className="shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded bg-white flex flex-row items-start justify-start py-0 px-2.5 whitespace-nowrap">
