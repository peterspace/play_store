...
const FrameComponent16 = ({
  ...
  const reviewsInfo1Style = useMemo(() => {
    return {
      padding: propPadding,
    };
  }, [propPadding]);
  ...
  const filledStarStyle = useMemo(() => {
    return {
      width: propWidth,
    };
  }, [propWidth]);

  const filledStar1Style = useMemo(() => {
    return {
      width: propWidth1,
    };
  }, [propWidth1]);

  const filledStar2Style = useMemo(() => {
    return {
      width: propWidth2,
    };
  }, [propWidth2]);

  const filledStar3Style = useMemo(() => {
    return {
      width: propWidth3,
    };
  }, [propWidth3]);
  ...
  return (
    <div
      className={`flex-1 flex flex-row items-start justify-start gap-[23px] min-w-[187px] text-left text-37xl text-gray-100 font-roboto ${className}`}
    >
          ...
          <div className="flex-1 flex flex-col items-start justify-start pt-[3px] px-0 pb-0">
            <div className="self-stretch flex flex-col items-start justify-start gap-1.5">
              <div className="self-stretch h-2.5 relative rounded-9980xl bg-whitesmoke-200">
                ...
                <div
                  className="absolute top-[0px] left-[0px] rounded-9980xl bg-seagreen-300 w-[135px] h-2.5 z-[1]"
              ...
              <div className="self-stretch h-2.5 relative rounded-9980xl bg-whitesmoke-200">
                <div className="absolute top-[0px] left-[0px] rounded-9980xl bg-whitesmoke-200 w-full h-full hidden" />
                <div
                  className="absolute top-[0px] left-[0px] rounded-9980xl bg-seagreen-300 w-20 h-2.5 z-[1]"
                  style={filledStar1Style}
                />
              </div>
              <div className="self-stretch h-2.5 relative rounded-9980xl bg-whitesmoke-200">
                <div className="absolute top-[0px] left-[0px] rounded-9980xl bg-whitesmoke-200 w-full h-full hidden" />
