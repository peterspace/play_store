...
const PhonePopChrome = () => {
  ...
  return (
    <div className="w-full relative flex flex-row items-start justify-start leading-[normal] tracking-[normal]">
      <main
        // className="h-[800px] flex-1 bg-white overflow-y-auto flex flex-col items-start justify-start pt-0 px-0 pb-[195px] box-border relative max-w-full text-left text-2xs text-dimgray font-roboto"
        // className="h-screen flex-1 bg-white overflow-y-auto flex flex-col items-start justify-start pt-0 px-0 pb-[195px] box-border relative max-w-full text-left text-2xs text-dimgray font-roboto"
        className={`${
          isPopUp
