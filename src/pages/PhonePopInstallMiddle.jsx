...
const PhonePopInstallMiddle = () => {
  return (
    <div className="w-full relative flex flex-row items-start justify-start leading-[normal] tracking-[normal]">
      <main className="h-[800px] flex-1 bg-white overflow-y-auto flex flex-col items-start justify-start pt-0 px-0 pb-[195px] box-border relative max-w-full text-left text-2xs text-dimgray font-roboto">
        <section className="self-stretch flex flex-row items-start justify-start pt-0 px-0 pb-10 box-border max-w-full shrink-0 text-left text-sm text-whitesmoke-200 font-roboto">
          <div className="flex-1 overflow-hidden flex flex-row items-start justify-start bg-[url('/hero-game@3x.png')] bg-cover bg-no-repeat bg-[top] shrink-0 max-w-full">
            <div className="flex-1 [background:linear-gradient(180deg,_rgba(0,_0,_0,_0.08)_31.77%,_#202124_40.56%)] overflow-hidden flex flex-col items-start justify-start pt-[89px] px-[30px] pb-8 box-border gap-16 max-w-full">
              <div className="self-stretch flex flex-row items-start justify-center">
                <div className="w-[110px] rounded-29xl bg-gray-200 overflow-hidden shrink-0 flex flex-row items-start justify-start py-2 pl-[23px] pr-4 box-border">
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start pt-0.5 px-0 pb-0">
                    <a className="[text-decoration:none] self-stretch relative tracking-[0.25px] leading-[20px] text-[inherit]">
                      Trailer
                    </a>
                  </div>
                </div>
              ...
              <div className="self-stretch flex flex-col items-start justify-start gap-[22px]">
                <DescriptionTag similarImage="/similar-image@2x.png" />
                ...
                <div className="self-stretch rounded-lg bg-seagreen-100 overflow-hidden flex flex-row items-start justify-center py-2 pl-[21px] pr-5 text-gray-100">
                  <div className="relative tracking-[0.25px] leading-[20px] inline-block min-w-[40px]">
                    Install
                  </div>
                </div>
                ...
                <div className="self-stretch flex flex-col items-start justify-start gap-2.5 text-darkgray">
                  <div className="flex flex-row items-start justify-start gap-5">
                    <input
                      className="m-0 h-5 w-5 overflow-hidden shrink-0"
                      type="checkbox"
                    />
        ...
        <section className="flex flex-row items-start justify-start pt-0 px-5 pb-5 box-border max-w-full shrink-0">
          <div className="w-[335px] overflow-x-auto shrink-0 flex flex-row items-start justify-start gap-10 max-w-full">
            <img
        ...
        <section className="self-stretch flex flex-row items-start justify-start pt-0 px-5 pb-5 box-border max-w-full shrink-0 text-left text-lg text-gray-100 font-roboto">
          <div className="flex-1 flex flex-col items-start justify-start gap-5 shrink-0 max-w-full">
            ...
            <div className="self-stretch h-[120px] overflow-hidden shrink-0 flex flex-row items-start justify-start max-w-full text-smi text-dimgray">
              <div className="h-40 flex-1 relative tracking-[0.2px] leading-[20px] inline-block max-w-full">
            ...
            <div className="w-[74px] h-11 flex flex-col items-start justify-start gap-1 text-sm">
        ...
        <section className="self-stretch flex flex-row items-start justify-start pt-0 pb-5 pl-5 pr-[30px] box-border max-w-full shrink-0 text-left text-sm text-dimgray font-roboto">
          <div className="h-[180px] flex-1 relative tracking-[0.2px] leading-[20px] inline-block shrink-0 max-w-full">
        ...
        <section className="self-stretch flex flex-row items-start justify-start pt-0 pb-5 pl-5 pr-[30px] box-border max-w-full shrink-0 text-left text-sm text-dimgray font-roboto">
          <div className="h-[220px] flex-1 relative tracking-[0.2px] leading-[20px] inline-block shrink-0 max-w-full">
        ...
        <div className="self-stretch h-px shrink-0 flex flex-row items-start justify-start py-0 px-5 box-border max-w-full">
          <div className="self-stretch flex-1 relative bg-whitesmoke-200 shrink-0 max-w-full z-[1]" />
        </div>
        <section className="w-full !m-[0] absolute h-full top-[0px] right-[0px] bottom-[0px] left-[0px] bg-gray-200 overflow-hidden shrink-0 flex flex-col items-center justify-center py-[306px] px-[7px] box-border z-[5]">
          <PopUpInstall
...
export default PhonePopInstallMiddle;
